<template>
    <div class="countainer flex gap-3 justify-between ">
        <NuxtLink class="insta icon-hover" to="https://instagram.com" target="_blank">
        ...
        <NuxtLink class="telegram icon-hover" to="https://telegram.com" target="_blank">
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24">
        ...
        <NuxtLink class="twitter icon-hover" to="https://twitter.com" target="_blank">
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" class="text-black">
        ...
        <NuxtLink class="facebook icon-hover" to="https://facebook.com" target="_blank">
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" class="text-black">
                <path fill="currentColor"
        ...
        <NuxtLink class="whatsapp icon-hover" to="https://whatsapp.com" target="_blank">
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" class="text-black">
                <path fill="currentColor"
        ...
        <NuxtLink class="youtube icon-hover" to="https://youtube.com" target="_blank">
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" class="text-black">
